...
```rs
use vencord_installer_core::update::download::prepare_dist_directory;
...
```rs
use vencord_installer_core::paths::locations::get_discord_locations;
...
```rs
use vencord_installer_core::patch::patch_mod::Installer;
